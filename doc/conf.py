...
html_theme_options = {
    ...
    "announcement": "Param 2.4.1 has just been released! Check out the <a href='https://blog.holoviz.org/posts/param_release_2.4/'>release blog post</a> and support Param by giving it a 🌟 on <a href='https://github.com/holoviz/param'>Github</a>.",
