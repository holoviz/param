...
#             a = param.FileSelector(path=glob)
...
#         p = self.P()
#         self.assertEqual(p.a, self.fa)

#     def test_objects_auto_set(self):
#         p = self.P()
#         self.assertEqual(p.param.a.objects, [self.fa, self.fb])
