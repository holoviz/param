...
class TestSelectorParameters(unittest.TestCase):
    ...
    def setUp(self):
        ...
        class P(param.Parameterized):
            ...
            i = param.Selector(objects=[9],default=7, check_on_set=False)
            s = param.Selector(objects=OrderedDict(one=1,two=2,three=3), default=3)
            p = param.Selector(objects=dict(one=1,two=2,three=3), default=3)
            d = param.Selector(objects=opts, default=opts['B'])
    ...
    def test_initialization_out_of_bounds(self):
        try:
            class Q(param.Parameterized):
                q = param.Selector(objects=[4], default=5)
        except ValueError:
            pass
        else:
    ...
    def test_initialization_no_bounds(self):
        try:
            class Q(param.Parameterized):
                q = param.Selector(objects=10, default=5)
        except TypeError:
            pass
        else:
